...
const NEWS_FORM_HELP_REPLY = [
  ...
  "และเลือกค่าตามตัวเลือก ไม่เช่นนั้นระบบอาจสร้างข่าวไม่สำเร็จครับ",
  "",
  " ตัวเลือกที่ใช้ได้:",
  ...
  "━━━━━━━━━━━━━━",
  "",
  " ถ้าต้องการให้ AI ช่วยเรียบเรียง ควรกรอกรายละเอียดอย่างน้อย 1-2 ประโยค",
  "AI จะใช้เฉพาะข้อมูลที่กรอก และไม่แต่งข้อมูลใหม่เอง",
].join("\n");
